...
<head>
	...
	<title>Axivis - Car Services and Repair HTML Template - Sign Up</title>
	<meta name="author" content="Vecuro">
  <meta name="description" content="Axivis - Car Services and Repair HTML Template">
  <meta name="keywords" content="Axivis - Car Services and Repair HTML Template" />
...
<div class="mobile-menu-wrapper ">
  <div class="mean-menu-area">
    ...
    <div class="mobile-logo">
      <a href="index.html"><img src="assets/img/logo.png" alt="axivis"></a>
    </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-6 col-md-3">
        <div class="logo">
          <a href="index.html"><img src="assets/img/logo-h3.png" alt="axivis"></a>
        </div>
      </div>
...
<!-- Header top area end -->    <!-- header Middle Area -->
     ...
     <!--   <div class="action-box d-flex  align-items-center">
      ...
      <!--  <div class="action-box d-flex align-items-center">
          ...
          <div class="content">
            ...
            <p class="text"><a href="mailto:contact@axivis.com">contact@axivis.com</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center" >
        ...
        <div class="col-8 col-lg-9 col-xl-7 text-right" data-aos="fade-down">
          <nav class="main-menu">
            <ul>
              <!--<li class="menu-item-has-children">
                <a href="admin-login.html">Register User</a>
                <!-- Sub Menu -->
               <!-- <ul class="sub-menu">
                  <li><a href="index.html">Home One</a></li>
                  <li><a href="index-2.html">Home Two</a></li>
              ...
              <li class="menu-item-has-children">
                <a href="adminplans.html">Add Plans</a>
                <!-- Sub Menu -->
               <!-- <ul class="sub-menu">
                  <li><a href="services.html">Services</a></li>
                  <li><a href="service-details.html">Services Details</a></li>
              ...
              <li class="menu-item-has-children">
                <a href="discount.html">Discount Coupons</a>
                <!-- Sub Menu -->
              <!--  <ul class="sub-menu">
                  <li><a href="team.html">Team</a></li>
                  <li><a href="team-details.html">Team Details</a></li>
        ...
        <!--<div class="col-lg-1 col-xl-3 text-right" data-aos="fade-left">
          <div class="header-btn">
            <a href="appointment.html" class="primary-btn d-none d-xl-inline-block no-shadow">Make An Appointment</a>
...
<!--<div class="breadcumb-wrapper breadcumb-layout1 background-image" data-img="assets/img/bg-img/breadcumb-bg.jpg">
    <div class="container">
        <div class="breadcumb-content">
            <!-- Breadcrumb Title -->
         <!--   <h1 class="breadcumb-title" data-aos="fade-left">Sign Up</h1>
...
<!-- signUp Area  -->
<div class="signUp-wrapper inner-form-wrap pt-130 pb-130">
  <div class="container">
    <div class="row justify-content-center"  data-aos="fade-up">
      <div class="col-lg-5">
        <form method="post" action="adminplans.php"  class="signUp-form">
          <?php include('errors.php'); ?>
          <!-- Form Title -->
          <h2 class="form-title">Add Plan</h2>
          <!-- Single Input -->
          <div class="form-group">
            <label for="plantitle" class="sr-only">Plan Title</label>
            <input type="text" class="form-control" placeholder="Name" id="plantitle"
              name="plan_name">
          </div>
          <div class="form-group">
            <label for="Description" class="sr-only">Plan Description</label>
            <input type="text" class="form-control" placeholder="Plan Description" id="Desription"
              name="desc">
          ...
          <div class='element form-group' id='div_1'>
            <input type='text' class="form-control" placeholder='Enter Feature 1' id='txt_1' name="feature_1" >
           </div>
            <div class='element form-group' id='div_1'>
            <input type='text' class="form-control" placeholder='Enter Feature 2' id='txt_1' name="feature_2" >
           </div>
         <div class='element form-group' id='div_1'>
            <input type='text' class="form-control" placeholder='Enter Feature 3' id='txt_1' name="feature_3" >
           </div>
         <div class='element form-group' id='div_1'>
            <input type='text' class="form-control" placeholder='Enter Feature 4' id='txt_1' name="feature_4">
           </div>
         <div class='element form-group' id='div_1'>
            <input type='text' class="form-control" placeholder='Enter Feature 5' id='txt_1' name="feature_5" >
           </div>
          <!-- Single Input -->
          <div class="form-group mb-0 text-center">
            <button class="primary-btn w-100" type="submit" name="reg_plan">Add Plan</button>
...
<!-- signUp Area end  -->
		...
		<!--	<div class="footer-wid-wrap pt-100 pb-100" >
			...
			<!--					<p><i class="fas fa-phone-alt"></i><a href="tel:+4256121289">+4256 121 289</a></p>
								<p><i class="fal fa-envelope"></i><a href="mailto:info@axivis.com">info@axivis.com</a></p>
		...
		<!--				<div class="col-md-9 col-lg-6 text-center text-md-right text-lg-center">
							<div class="copyright">
								<p class="text">&copy; 2020 <a href="index.html">Axivis.</a> All Rights Reserved. <a
										href="https://vecuro.com/">Vecuro</a>.</p>
							</div>
						</div>
...
<!--<div class="sidemenu-wrapper d-none d-lg-block ">
  ...
  <!--  <div class="widget sidemenu-widget widget_about mb-0">
      ...
      <p class="about-text">Quickly recaptiualize real-time interfaces and timely models. Proactively exploit viral meta-services for interdependent customer service. Dynamically actualize bleeding-edge internal</p>
    </div>
    <!-- Single Widget -->
...
$("#addRow").click(function(){
 ...
 if(total_element < max ){
  ...
  $("#div_" + nextindex).append("<input type='text' class='form-control' placeholder='Enter Feature' id='txt_"+ nextindex +"'>&nbsp;<button id='remove_" + nextindex + "' class='remove'>X</button>");
