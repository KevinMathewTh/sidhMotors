...
if (mysqli_connect_errno())
    ...
    $error="";
    $key=$_POST["loginUserId"];
    $enteredPass=$_POST["loginUserPass"];
    $sql = 'SELECT fname,pass,wallet FROM users WHERE email="'.$key.'"';
        if ($res=mysqli_query($conn, $sql))
            {
              if(mysqli_num_rows($res) > 0){ 
                while($row = mysqli_fetch_array($res)){ 
                    if(md5($enteredPass)==$row['pass'])
                    {
                      $_SESSION['user']=$row['fname'];
                      $_SESSION['pts']=$row['wallet'];
                ...
                $error.="No Matching records are found."; 
            } 
            } 
        else {
...
<head>
	...
	<title>Axivis - Car Services and Repair HTML Template - Sign in</title>
...
<div class="breadcumb-wrapper breadcumb-layout1 background-image" data-img="assets/img/bg-img/breadcumb-bg.jpg">
    <div class="container">
        <div class="breadcumb-content">
            <!-- Breadcrumb Title -->
            <h1 class="breadcumb-title" data-aos="fade-left">Sign in</h1>
...
<!-- Login Area  -->
<div class="login-wrapper inner-form-wrap pt-130 pb-130">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5"  data-aos="fade-up">
        <form method="POST" class="login-form">
          ...
          {
           $accCreateMsg ="</p>Your account has succesfully been created, please login to continue to our website</p>";
           echo '<div class="alert alert-success" role="alert">'.$accCreateMsg.'</div>';
          ...
          <div class="form-group mb-0 text-center">
            <input name="loginBtn" class="primary-btn w-100" type="submit">
            <div class="bottom-links d-md-flex justify-content-between mt-3">
