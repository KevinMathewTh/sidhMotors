...
<div class="signUp-wrapper inner-form-wrap pt-130 pb-130">
  <div class="container">
    <div class="row justify-content-center"  data-aos="fade-up">
      <div class="col-lg-5">
        <form method="post" action="admin-login.php" class="signUp-form">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Name" id="signUpUserName"
              name="username">
          </div>
          <div class="form-group">
            <label for="signUpPhone" class="sr-only">Phone Number</label>
            <input type="text" class="form-control" placeholder="Phone Number" id="signUpPhone"
              name="phone">
          </div>
          <!-- Single Input -->
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" placeholder="Confirm Password" id="signUpUserPass"
              name="password_2">
          </div>
          <!-- Single Input -->
          <!-- Single Input -->
          <div class="form-group mb-0 text-center">
            <button class="primary-btn w-100" type="submit" name="reg_user">Register</button>
          </div>
