      ...
      <div class="col-md-6 text-right"  data-aos="fade-right">
        ...
        <div class="header-top-right">
          <ul class="header-top-links">
            ...
            <li><span><i class="far fa-user"></i><a href="login.php">Login</a> | <a href="sign-up.html">Sign
                  Up</a></span></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <form method="POST" class="signUp-form">
          ...
          <div class="form-group">
           ...
           <!-- Single Input -->
           <div class="form-group">
            <label for="signUpPhone" class="sr-only">Phone</label>
            <input type="text" class="form-control" placeholder="Phone" id="signUpPhone"
              name="signUpPhone">
          </div>
          <!-- Single Input -->
          <div class="form-group">
          ...
          <!-- Single Input -->
          <div class="form-group">
            <label for="signUpUserCPass" class="sr-only">Confirm Password</label>
            <input type="password" class="form-control" placeholder="Confirm Password" id="signUpUserCPass"
              name="signUpUserCPass">
          </div>
          <!-- Single Input -->
          <div class="form-group">
            <label for="signUpUserReferral" class="sr-only">Referral Code</label>
            <p>Referal Code if any</p>
            <input type="text" class="form-control" placeholder="XXXXX" id="signUpUserReferral"
              name="signUpUserReferral">
          </div>
          <!-- Single Input -->
          <div class="form-group">
          ...
          <div class="form-group mb-0 text-center">
            <input name="createAccSubmit" class="primary-btn w-100" type="submit">
